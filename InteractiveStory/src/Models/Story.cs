...
namespace InteractiveStory
{
	public class Story
	{
		...
		public Story ()
		{
			...
			mPages[4] = new Page(
				Resource.Drawable.page4,
				"The rover is covered in dust and most of the solar panels are broken. But you are quite surprised to see the on-board system booted up and running. In fact, there is a message on the screen: \"{0}, come to 28.543436, -81.369031.\" Those coordinates aren't far, but you don't know if your oxygen will last there and back.",
				new Choice("Explore the coordinates", 5),
				new Choice("Return to Earth", 6));

			mPages[5] = new Page(
				Resource.Drawable.page5,
				"After a long walk slightly uphill, you end up at the top of a small crater. You look around, and are overjoyed to see your favorite android, {0}-S1124. It had been lost on a previous mission to Mars! You take it back to your ship and fly back to Earth.");
